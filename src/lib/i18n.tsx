...
const translations = {
  en: {
    ...
    "hero.description":
      "dedicated to building high quality digital products that balance aesthetic precision with technical excellence",
    "hero.cta": "Get in touch",
    "hero.focus1": "Freelance Work",
    "hero.focus2": "Web Development",
    "hero.focus3": "Full-Stack Engineering",
    "hero.focus4": "Clean, scalable, and maintainable code",
    ...
    "about.path4Subtitle": "Coaching kids long before any code",
    ...
    "about.path3Subtitle": "Ran shift operations, learned to own a room and keep it moving under pressure",
    "about.path5Title": "Information Systems Student",
    "about.path5Subtitle": "Foundation in software sys - Java, Python, SQL, and object-oriented programming",
    "about.path1Title": "Freelance Developer",
    "about.path1Subtitle": "Building clean, real-world web apps for real clients to our present day",
    ...
    "about.quote3Text": "I don't just write code that works | I write code that's easy to come back to. That's what",
    "about.quote3Highlight": "\"clean\" actually means.",
    "about.quote4Text": "Anyone can start a project. Finishing it, properly is",
    "about.quote4Highlight": "the part that actually matters.",
    "about.quote5Text": "I ask \"why\" before I ask \"how.\" Good code starts with",
    "about.quote5Highlight": "understanding the problem.",
    ...
    "projects.featured.description":
      "A private chef website | from layout to motion, bilingual website designed and built end-to-end, with a custom admin panel behind the scenes.",
  ...
  ar: {
    ...
    "about.quote3Text": "لا أكتفي بكتابة كود يعمل — أكتب كودًا يسهل الرجوع إليه لاحقًا. هذا ما يعنيه فعلاً",
    "about.quote3Highlight": "أن يكون الكود \"نظيفًا\".",
    "about.quote4Text": "أي شخص يمكنه أن يبدأ مشروعًا. إنهاؤه — بإتقان — هو",
    "about.quote4Highlight": "الجزء الذي يهم فعلاً.",
    "about.quote5Text": "أسأل \"لماذا\" قبل أن أسأل \"كيف\". الكود الجيد يبدأ من",
    "about.quote5Highlight": "فهم المشكلة.",
